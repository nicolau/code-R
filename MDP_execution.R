...
for(id in names(studies)) {
  expressionFile <- studies[[id]][["expression"]]
  phenodataFile  <- studies[[id]][["phenodata"]]
  outputDir      <- studies[[id]][["outdir"]]
  controlLabel   <- studies[[id]][["control"]]
