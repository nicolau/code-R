run_fgsea <- function( pathwaysDatabase, ranksOfGenes, ranksFromR, minSizeGroup = 15, maxSizeGroup = 500, npermGroup = 1000, filterPathways = FALSE, pFilter = 0.05 ) {
  ##### Enrichment analysis
  ### Read GMT file
